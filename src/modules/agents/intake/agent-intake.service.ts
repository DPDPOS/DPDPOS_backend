...
import type { AgentPrismaClient } from "../types/agent.types.js";
...
export class AgentIntakeService {
  async intake(ctx: RequestContext, input: AgentIntakeDto) {
...
export const agentIntakeService = new AgentIntakeService();
